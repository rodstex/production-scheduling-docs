...
with base_records as (
    ...
    from ${dwh_schema}.dim_date dd
        join ${dwh_schema}.fact_production_schedule fps on fps.inserted_dt_utc::date = dd.dt
            ...
            and date_trunc('week', fps.inserted_dt_utc)::date = (date_trunc('week', current_timestamp at time zone '${timezone}') + interval '7 day')::date
