...
where ps.grouped_line_type = 'Non-Automated'
    ...
    and date_trunc('week', ps.dt)::date >= (date_trunc('week', current_timestamp at time zone '${timezone}' + interval '14 day'))::date