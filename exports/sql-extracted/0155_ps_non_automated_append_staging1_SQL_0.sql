...
, base_records as (
    select
        ...
        ,coalesce(lag(t.sku_without_merv_rating) over (partition by t.mapped_manufacturing_location, t.line_type order by t.ranking asc, t.mapped_distribution_location asc, t.merv_rating asc)
        ...
        ,case when prior_sku_without_merv_rating is null then 0::decimal
            when t.sku_without_merv_rating = prior_sku_without_merv_rating then 0::decimal
